          ...
          <form action="#" method="POST" className="mt-8">
            <div className="space-y-5">
              ...
              <p className="text-red-600 font-bold mb-3">{errorMessage}</p>
                <button
                  type="button"
                  className="inline-flex border w-full items-center justify-center rounded-md bg-black px-3.5 py-2.5 font-semibold leading-7 text-white hover:bg-black/80"
